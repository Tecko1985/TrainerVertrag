    ...
    groups: [
      {
        title: "Sonstiges",
        items: [
          "Bestätigungs-Screen: Button „← Zur Übersicht\" führt zurück zur zentralen Tools-Übersicht."
        ]
      }
    ]
  },
    ...
    groups: [
      {
        title: "Sonstiges",
        items: [
          "Bestätigungsscreen zeigt nach dem Absenden alle übermittelten Daten und die Unterschrift zur Selbstkontrolle an."
        ]
      }
    ]
  },
